...
declare global {
  interface Window {
    ...
    /** Injected by the OPC-Nexus Main proxy; never sourced from URL state. */
    __OPC_NEXUS_PROJECT_MODE__?: "desktop" | "mobile-operator";
    /** Main-owned desktop theme. Project-mode Hermes follows this value. */
    __OPC_NEXUS_THEME__?: "dark" | "light";
  }
}
