...
class MemoryStore:
    ...
    def __init__(
        ...
        # None preserves upstream's dynamic HERMES_HOME/profile behaviour.
        # Nexus supplies a validated project- or employee-scoped directory.
    ...
    def _memory_dir(self) -> Path:
        return self.memory_dir if self.memory_dir is not None else get_memory_dir()
