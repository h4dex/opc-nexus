...
> Archived upstream reference for `raulvidis/hermes-android@5f2f8ab`. It does not
> describe the current OPC-Nexus transport or security model. OPC-Nexus removes
> the phone-side Ktor listener and six-character pairing code; the production app
> uses outbound pinned WSS, one-time 256-bit pairing secrets, and ECDSA device identity.
