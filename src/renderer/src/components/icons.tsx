...
export const IconMic = svg('M12 15a4 4 0 0 0 4-4V6a4 4 0 0 0-8 0v5a4 4 0 0 0 4 4z', 'M5 11a7 7 0 0 0 14 0M12 18v4M9 22h6');
export const IconFullscreen = svg('M8 3H3v5M16 3h5v5M8 21H3v-5M16 21h5v-5');
...
export const IconPhone = svg('M8 2h8a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2z', 'M10 5h4M11 19h2');
export const IconChevronLeft = svg('M15 18l-6-6 6-6');
export const IconChevronRight = svg('M9 18l6-6-6-6');
export const IconUpload = svg('M12 21V9m0 0 5 5m-5-5-5 5', 'M5 4h14');
export const IconCopy = svg('M8 8h12v12H8z', 'M4 4h12v4M4 4v12h4');
